...
pred_latent_classes_aff_train = model.proj_in(enc_out_aff_train)

dec_in_cond_aff_train = model.proj_out(pred_latent_classes_aff_train)
...
pred_latent_classes_neg_train = model.proj_in(enc_out_neg_train)

dec_in_cond_neg_train = model.proj_out(pred_latent_classes_neg_train)

dec_in_cond_diff_train = dec_in_cond_neg_train - dec_in_cond_aff_train
...
pred_latent_classes_neg_test = model.proj_in(enc_out_neg_test)

dec_in_cond_neg_test = model.proj_out(pred_latent_classes_neg_test)

dec_in_cond_add_test = dec_in_cond_diff_train + dec_in_cond_neg_test
...
recon_logits_airth = model.decoder(
    encoder_hidden_states=dec_in_cond_add_test, 
